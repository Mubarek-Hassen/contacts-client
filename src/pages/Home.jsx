...
function Home() {
  return (
    <section className=" max-w-fit flex justify-center flex-col m-auto my-20">
      ...
      <Link className="w-fit text-center my-8 border-black border-2 p-2 m-auto text-slate-200 hover:text-slate-900 bg-slate-800 hover:bg-slate-100 rounded" to="/auth?mode=login">Get Started!</Link>
    </section>
  )
}
export default Home